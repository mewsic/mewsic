...
class RatedTest < Test::Unit::TestCase
  ...
  def check_average obj, value
    check_average_step_one obj, value
    check_average_step_two obj, value
  end
  
  def check_average_step_one obj, value
    assert_equal (value * 100).to_i, (obj.rating_average * 100).to_i    
  end
  
  def check_average_step_two obj, value
    assert_equal (obj.ratings.average(:rating).to_f * 100).to_i, (obj.rating_average * 100).to_i, "Error with #{obj.class}##{obj.id}"
  end
