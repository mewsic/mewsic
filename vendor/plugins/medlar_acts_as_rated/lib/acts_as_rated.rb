    ...
    module Rated
      ...
      module ClassMethods
        ...
        def acts_as_rated(options = {})
          ...
          rater_as_class.class_eval do
            has_many :given_ratings, :foreign_key  => :rater_id, :class_name => rating_class.to_s
          end
        end
      end
      ...
      module ClassMethods
        ...
        def generate_ratings_columns table
          ...
          table.column :rating_total, :decimal, :precision => 10, :scale => 2
        ...
        def add_ratings_columns
          if !self.content_columns.find { |c| 'rating_count' == c.name }
            ...
            self.connection.add_column table_name, :rating_total, :decimal, :precision => 10, :scale => 2
        ...
        def create_ratings_table options = {}
          ...
          unless stats_table.nil?
            self.connection.create_table(stats_table) do |t|
              ...
              t.column :rating_total, :decimal, :precision => 10, :scale => 2
