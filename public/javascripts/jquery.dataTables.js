...
(function($) {
	...
	$.fn.dataTableExt.oPagination = {
	     ...
	     *           function:fnCallbackDraw - draw function which must be called on update
			...
			"fnInit": function ( oSettings, fnCallbackDraw )
			{
				...
				nFirst.className = "pager";
				nPrevious.className = "mailbox_prev";
				nNext.className = "mailbox_next";
				nLast.className = "pager";
	     ...
	     *           function:fnCallbackDraw - draw function which must be called on update
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				{
					if ( iCurrentPage != i )
						sList += '<li class="bullet"><span class="off"> </span></li>';
					else
						sList += '<li class="bullet"><span class="on"> </span></li>';
				}
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlPaginate ( oSettings )
		{
			...
			nPaginate.className = "bullet_paging";
