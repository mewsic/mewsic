...
class MessagesController < ApplicationController
  ...
  # <tt>GET /users/:user_id/messages</tt>
  #
  ...
  # <tt>GET /users/:user_id/messages/sent</tt>
  #
  ...
  # <tt>GET /users/:user_id/messages/unread</tt>
  #
  ...
  # <tt>GET /users/:user_id/messages/:id</tt>
  #
  ...
  # <tt>GET /users/:user_id/messages/new</tt>
  #
  ...
  # <tt>POST /users/:user_id/messages</tt>
  #
  ...
  # <tt>DELETE /users/:user_id/messages/:id</tt>
  #
