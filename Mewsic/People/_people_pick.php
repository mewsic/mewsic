<!-- Moved into app/views/users/_pick_of_the_week.html.erb -->
...
<div class="pick_wrap">
		...
		<div class="w454 fleft">
			...
			<!-- non e' esploso, e' solo per vedere i blocchi instr :_) -->
			<? for($i=0;$i<4;$i++){ include('_instrument_block.php'); } ?>
		</div>
		<!-- END SONG BLOCK -->
</div>
<div class="clear"> </div>
