...
This application was developed by http://mikamai.com/ and http://lime5.it/, reached a hiatus
and its source code is now released in the public domain. Of course, forks and contributions
...
You'll find API keys and IPs in the sources, but don't bother trying to use them: they're
expired and no more valid :-) but full source and history has been preserved for educational
purposes.
